...
class _FirestoreIslemleriState extends State<FirestoreIslemleri> {
  ...
  void _veriEkle() {
    ...
    Map<String, dynamic> sebzemeyve = Map();
    // sebzeler
    sebzemeyve['domates'] = "3";
    sebzemeyve['patlıcan'] = "4.5";
    sebzemeyve['biber'] = "5";
    sebzemeyve['salatalık'] = "3";
    sebzemeyve['sogan'] = "2";
    // meyveler
    sebzemeyve['muz'] = "2";
    sebzemeyve['mandalina'] = "2";
    sebzemeyve['portakal'] = "2";
    sebzemeyve['nar'] = "2";
    sebzemeyve['elma'] = "2";
    sebzemeyve['armut'] = "2";
    ...
    _firestore.collection("Urunler").doc("SebzelerMeyveler").set({'Domates' : '1.5'});

    _firestore.collection("users").doc("emre_altunbilek").set(emreEkle, SetOptions(merge: true)).then((v) => debugPrint("emre eklendi"));
    ...
    _firestore.doc("users/$yeniKullaniciID").set({'yas': 30, 'userID': '$yeniKullaniciID'});
  ...
  Future _veriOku() async {
    ...
    _firestore.collection("users").get().then((querySnapshots) {
      debugPrint("User koleksiyonundaki eleman sayısı:" + querySnapshots.docs.length.toString());
